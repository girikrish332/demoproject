...
declare function expect(spy: Function): fun.Matchers;
declare function expect(actual: any): fun.Matchers;

declare function fail(e?: any): void;

declare function spyOn(object: any, method: string): fun.Spy;
...
declare module fun {
    ...
    interface ObjectContaining {
        ...
        funMatches(other: any, mismatchKeys: any[], mismatchValues: any[]): boolean;
        funToString(): string;
    }
    ...
    interface Env {
        ...
        // ddescribe(description: string, specDefinitions: () => void): Suite; Not a part of fun. Angular team adds these
        ...
        // iit(description: string, func: () => void): Spec; Not a part of fun. Angular team adds these
